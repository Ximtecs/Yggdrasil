module ScalingHL_mod
    ...
    mutable struct ScalingHL
        ...
        function ScalingHL(base_units :: BaseUnits, n = 1e15, l=1e8, T=1e6, Te = 1e6, Tp = 1e6, B = 10, l_s = 1e8, t_s  = 100, rho_s = 1e-13, Temp_s = 1, ds = 0.1, PPC = 128 )
            system = base_units.system
            obj = new(system, n, l, T, Te, Tp, B, l_s, rho_s, t_s,Temp_s, base_units)
            copy_base_units(obj)
