module BaseUnits_mod
    using Printf

    export BaseUnits, set_base_physical_values, scale_base_units, print_all
    ...
    mutable struct BaseUnits
        ...
        """
        function BaseUnits(system::String, eps_0_scaling::Float64=1.0, mu_0_scaling::Float64=1.0, m_e_scaling::Float64=1.0, charge_scaling::Float64=1.0)
            ...
            #----------- set default scaling to 1.0 (no scaling) ----------------
            scale_base_units(obj, eps_0_scaling, mu_0_scaling, m_e_scaling, charge_scaling)
            #---------------------------------------------------------------------
            return obj
        end
    end
